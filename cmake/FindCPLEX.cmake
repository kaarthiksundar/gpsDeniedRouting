...
elseif(UNIX)
    file(GLOB dirs /projects/opt/ibm/ILOG/CPLEX_Studio128)
    foreach(d in ${dirs})
        string(REGEX MATCH "Studio[0-9]+" CPLEX_VERSION "${d}")
    endforeach(d)
    string(SUBSTRING ${CPLEX_VERSION} 6 -1 CPLEX_VERSION)
...
elseif(UNIX)
    string(CONCAT CPLEX_DIR /projects/opt/ibm/ILOG/CPLEX_Studio;${CPLEX_VERSION};/cplex)
    string(CONCAT CONCERT_DIR /projects/opt/ibm/ILOG/CPLEX_Studio;${CPLEX_VERSION};/concert)
endif()
